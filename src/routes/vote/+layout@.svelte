<script lang="ts">
	...
	import { Header, HeaderAction, HeaderActionLink, HeaderUtilities, SideNav, SideNavItems, SideNavMenuItem } from "carbon-components-svelte";
...
<SideNav bind:isOpen={isSideNavOpen}>
    <SideNavItems>
        ...
        <SideNavMenuItem id={position.id} isSelected={data.currentSelected === position.id} href="/vote/{position.id}" data-sveltekit-preload-data="tap">{position.title}</SideNavMenuItem>
        {/each}
    </SideNavItems>
</SideNav>
