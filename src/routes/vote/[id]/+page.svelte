<script>
	...
	import { Button, Column, Content, Grid, RadioTile, Row, Tile, TileGroup } from 'carbon-components-svelte';
	 ...
	 */
     ...
     function castVote() {
        ...
        pb.collection('polls').getFirstListItem(`user="${pb.authStore.model.id}"`).then((res)=> {
